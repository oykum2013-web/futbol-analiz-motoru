...
2. **CLAUDE.md'deki "Model metodolojisi" bölümünde tanımlı 4 bileşeni uygula:**
   ...
   d. `knowledge/model-performance.md`'deki geçmiş kalibrasyon notlarını kontrol et — model sistematik olarak aşırı/az özgüvenliyse yüzdeleri hafifçe ayarla ve bunu belirt.
