...
- **`ajan_ordusu/`** — Python çoklu ajan tahmin motoru (prototip). Ajanlar:
  ...
  - Tahmin (`agents/prediction.py`) — form + H2H + kadro etkisini birleştirip olasılık tabanlı tahmin üretir
  - Orkestratör (`agents/orchestrator.py`) — yukarıdakileri sırayla çalıştırıp Markdown rapor üretir
  - Henüz eklenmedi: Oran/Piyasa Ajanı, Rapor & Bülten Ajanı, n8n entegrasyonu
